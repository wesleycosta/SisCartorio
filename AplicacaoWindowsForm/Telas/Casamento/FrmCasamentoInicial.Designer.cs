...
{
	partial class FrmCasamentoInicial
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// columnHeader8
			// 
			this.columnHeader8.Text = "Nome Contraente 2";
			this.columnHeader8.Width = 225;
			// 
			// columnHeader2
			// 
			this.columnHeader2.Text = "Dt Reg.";
			this.columnHeader2.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.columnHeader2.Width = 80;
			// 
			// columnHeader1
			// 
			this.columnHeader1.Text = "Nome Contraente 1";
			...
			this.lvwDados.Location = new System.Drawing.Point(10, 109);
			this.lvwDados.Name = "lvwDados";
			this.lvwDados.Size = new System.Drawing.Size(718, 364);
			this.lvwDados.TabIndex = 6;
			...
			this.lbEditar.Click += new System.EventHandler(this.pbEditar_Click);
			// 
			// panel2
			// 
			...
			// columnHeader9
			// 
			this.columnHeader9.Text = "Dt Nasc. C1";
			this.columnHeader9.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.columnHeader9.Width = 80;
			// 
			// columnHeader10
			// 
			this.columnHeader10.Text = "Dt Nasc. C1";
			...
			this.Name = "FrmCasamentoInicial";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Registros de Nascimento";
